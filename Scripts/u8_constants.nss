...
const string U8_WP_PORTAL_ENCLAVE = "WP_PortalEnclave";  // Sorcerer's Enclave/Daemons Crag (Fire)
const string U8_WP_PORTAL_CARTHAX = "WP_PortalCarthax";  // Carthax Lake/Hydros Lair (Water)
...
const string U8_TT_PORTAL_ENCLAVE = "TT_PortalEnclave";  // Sorcerer's Enclave/Daemons Crag (Fire)
const string U8_TT_PORTAL_CARTHAX = "TT_PortalCarthax";  // Carthax Lake/Hydros Lair (Water)
